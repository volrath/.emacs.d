;;; vlt-config-grep.el ---  -*- lexical-binding: t; -*-
;;
;; Filename: vlt-config-grep.el
;; Description:
;; Author: Daniel Barreto
;; Maintainer:
;; Copyright (C) 2017 Daniel Barreto
;; Created: Wed Sep 13 01:40:33 2017 (+0200)
;; Version:
;; Package-Requires: ()
;; Last-Updated:
;;           By:
...
(provide 'vlt-config-grep)

;;; vlt-config-grep.el ends here
